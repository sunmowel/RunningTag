...
volatile uint16_t g_tau0_ch0_count = 0UL;
volatile uint16_t g_tau0_ch1_count = 0UL;
volatile uint16_t g_tau0_ch2_count = 0UL;
volatile uint8_t g_tau0_ch3_flag = 0UL;
/* End user code. Do not edit comment generated here */
